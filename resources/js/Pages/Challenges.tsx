...
export default function Challenges({ users, posts }: Props) {
            ...
            <main className="flex-1 lg:ml-72 lg:mr-72 lg:mt-0 p-6 pt-3 pb-28 w-full max-w-screen-xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {[...Array(9)].map((_, i) => (
                        <div
                            key={i}
                            className="bg-gray-900 border border-gray-800 rounded-xl p-5 shadow-md hover:shadow-lg transition flex flex-col justify-between"
                        >
                            <div>
                                ...
                                <p className="text-sm text-gray-400">
                                    Získej 5 výher v řadě nebo vyhraj proti
                                    vyššímu ranku...
                                </p>
                            </div>
