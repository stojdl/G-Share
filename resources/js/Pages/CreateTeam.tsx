...
export default function CreateTeam({ users, posts }: Props) {
    ...
    const isAnyModalOpen = isAddFriendOpen || isNotifModalOpen || isChatOpen;
    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row bg-black text-white">
            ...
            {/* Main Content */}
            <main className="flex-1 lg:ml-72 lg:mr-72 lg:mt-0 p-6 pt-3 pb-20 w-full max-w-screen-xl mx-auto space-y-8">
