        ...
        <>
            <div>
                ...
                {users.map((user: any, i: number) => (
                    <div
                        key={user.id}
                        className="border p-4 m-4 bg-gray-50 text-black"
                    >
                        <p>
                            {i + 1}. ID: {user.id}
                        </p>
                        ...
                        <div>
                            ...
                            {user.posts?.map((post: any, j: number) => (
                                <div
                                    key={post.id}
                                    className="border p-4 my-4 bg-white rounded"
                                >
                                    <p>ID: {post.id}</p>
                                    ...
                                    <div>
                                        ...
                                        {post.comments?.map(
                                            (comment: any, k: number) => (
                                                <div
                                                    key={comment.id}
                                                    className="border p-4 my-2 bg-gray-100 rounded"
                                                >
                                                    <p>ID: {comment.id}</p>
                                                    <p className="font-bold">
                                                        {k + 1}. {comment.body}
                                                        ...
                                                        {comment.children?.map(
                                                            (
                                                                ...
                                                                <div
                                                                    ...
                                                                    className="border p-3 my-2 bg-gray-50 rounded"
                                                                >
                                                                    <p className="font-bold">
                                                                        {l + 1}.{" "}
                                                                        {
