...
export default function Tournaments({ users, posts }: Props) {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-black text-white lg:flex-row">
            ...
            <main className="flex-1 lg:ml-72 lg:mr-72 lg:mt-0 p-6 pt-3 pb-28 w-full max-w-screen-xl mx-auto space-y-8">
                ...
                {/* Filters Section */}
                <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6 shadow space-y-4">
                    <p className="text-gray-400 text-sm">
                        Vytvářej a filtruj turnaje podle preferencí hráčů.
                    </p>
                    <div className="flex flex-wrap gap-3">
                        {[
                            ...
                            <input
                                ...
                                type="text"
                                placeholder={filter}
                                className="bg-gray-800 border border-gray-700 px-4 py-2 rounded text-sm placeholder-gray-400 text-white shadow"
                            />
                        ))}
                        <button className="bg-red-600 hover:bg-red-700 text-white font-semibold px-5 py-2 rounded text-sm shadow">
                            Vytvořit turnaj
                        </button>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {[...Array(9)].map((_, i) => (
                        <div
                            key={i}
                            className="bg-gray-900 border border-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition flex flex-col items-start gap-2"
                        >
                            ...
                            <button className="mt-auto text-sm text-red-400 hover:text-red-300 transition">
                                Zobrazit
                            </button>
                        </div>
                    ))}
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-xl min-h-[200px] flex items-center justify-center text-gray-500 shadow-md">
                    ⚙️ Další funkce nebo výpisy zde (např. výsledky, aktivní
                    zápasy...)
                </div>
            </main>
